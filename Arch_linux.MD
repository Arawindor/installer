...
#### This guide is based on "How to install Arch Linux with full disk encryption (BTRFS) and KDE Plasma Desktop Environment" video by Sheridan Computers (https://www.youtube.com/watch?v=hJRfMgpke3E)
